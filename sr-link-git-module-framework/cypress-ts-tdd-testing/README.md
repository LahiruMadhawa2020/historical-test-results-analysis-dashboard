# Sr Link — Cypress TypeScript TDD

**Project:** Sr Link | **Framework:** sr-link-git-module-framework | **Folder:** `cypress-ts-tdd-testing`
...
cd ..\sr-link-git-module-framework\cypress-ts-tdd-testing
npm install
```
