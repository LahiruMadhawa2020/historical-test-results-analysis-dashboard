# DELL — WebdriverIO TypeScript BDD

**Project:** DELL | **Framework:** dell-maven-module-framework | **Folder:** `wdio-ts-bdd-testing`
...
cd ..\dell-maven-module-framework\wdio-ts-bdd-testing
npm install
```
