...
| Dashboard | URL |
|-----------|-----|
| Landing page | https://publisheswithlahiru91.github.io/historical-test-results-analysis-dashboard/ |
| WK project dashboard | https://publisheswithlahiru91.github.io/historical-test-results-analysis-dashboard/wk-dashboard.html |
| DELL project dashboard | https://publisheswithlahiru91.github.io/historical-test-results-analysis-dashboard/dell-dashboard.html |
| Sr Link project dashboard | https://publisheswithlahiru91.github.io/historical-test-results-analysis-dashboard/sr-link-dashboard.html |
| Management dashboard | https://publisheswithlahiru91.github.io/historical-test-results-analysis-dashboard/management-dashboard.html |

> Use the **`github.io`** links above — not the GitHub repo file browser (`github.com/.../blob/...`).

### If you see 404 or blank pages

1. Open [Settings → Pages](https://github.com/publisheswithlahiru91/historical-test-results-analysis-dashboard/settings/pages) and set **Deploy from a branch** → **`gh-pages`** → **`/ (root)`** → **Save**.
